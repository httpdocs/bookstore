...
$(function($){
    ...
    function bookList(){
        ...
        $.each(catalog,function(i,n){
            ...
            html+="<li class='product_storyList_content_dash'><a href='/dangdang_imate/book_details.html' class='blue_14'>"+n[1]+"</a></li>";
            html+="<li>顾客评分：";
            for(var k=0;k<5;k++){
                if(k<n[2]){
            ...
            html+="<dd><a href='/dangdang_imate/shopping.html'><img src='images/product_buy_02.gif' alt='shopping'/></a>";
            html+="<dd><a href='/dangdang_imate/shopping.html'><img src='images/product_buy_01.gif' alt='shopping'></a></dd>";
            html+="<dd>节省："+n[7]+"</dd>";
